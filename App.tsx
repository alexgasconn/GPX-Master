...
const App: React.FC = () => {
    ...
    // Allow selecting multiple tracks in the sidebar (e.g., Ctrl/Cmd+click)
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        if (e.target.files && e.target.files.length > 0) {
                                            Array.from(e.target.files).forEach(f => handleFileLoad(f));
                                        }
                                    }}
                                    className="hidden"
                                />
                                    ...
                                    <TrackManager
                                        ...
                                        onSelectTrack={(id, isMulti) => {
                                            if (isMulti) {
                                                ...
                                                // Keep primary active track unchanged when multi-selecting
                                            } else {
                                                // Single click: set as primary and reset selection to that one
                                                setActiveTrackId(id);
